...
<%
    ...
    String productName = (String)request.getAttribute("productName"); //汽车名称查询关键字
...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>Product/frontlist">汽车信息列表</a></li>
  			<li class="active">查询结果显示</li>
  			<a class="pull-right" href="<%=basePath %>Product/product_frontAdd.jsp" style="display:none;">添加汽车</a>
		</ul>
		<div class="row">
			<%
				/*计算起始序号*/
				...
				for(int i=0;i<productList.size();i++) {
            		...
            		Product product = productList.get(i); //获取到汽车对象
            		String clearLeft = "";
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>Product/<%=product.getProductId() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=product.getMainPhoto()%>" /></a>
			     <div class="showFields">
			     	<div class="field">
	            		汽车id:<%=product.getProductId() %>
			     	</div>
			     	<div class="field">
	            		汽车类别:<%=product.getProductClassObj().getClassName() %>
			     	</div>
			     	<div class="field">
	            		汽车名称:<%=product.getProductName() %>
			     	</div>
			     	<div class="field">
	            		汽车单价（万）:<%=product.getProductPrice() %>
			     	</div>
			     	<div class="field">
	            		汽车库存:<%=product.getProductCount() %>
			     	</div>
			     	<div class="field">
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="productQueryForm" id="productQueryForm" action="<%=basePath %>Product/frontlist" class="mar_t15">
            <div class="form-group">
            	<label for="productClassObj_classId">汽车类别：</label>
			...
			<div class="form-group">
				<label for="productName">汽车名称:</label>
				<input type="text" id="productName" name="productName" value="<%=productName %>" class="form-control" placeholder="请输入汽车名称">
			</div>
			<div class="form-group">
  ...
  <div class="modal-dialog" style="width:900px;" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;汽车信息编辑</h4>
      </div>
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="product_productId_edit" class="col-md-3 text-right">汽车id:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="product_productId_edit" name="product.productId" class="form-control" placeholder="请输入汽车id" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
		  	 <label for="product_productClassObj_classId_edit" class="col-md-3 text-right">汽车类别:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="product_productName_edit" class="col-md-3 text-right">汽车名称:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="product_productName_edit" name="product.productName" class="form-control" placeholder="请输入汽车名称">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="product_mainPhoto_edit" class="col-md-3 text-right">汽车主图:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="product_productPrice_edit" class="col-md-3 text-right">汽车单价（万）:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="product_productPrice_edit" name="product.productPrice" class="form-control" placeholder="请输入汽车单价（万）">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="product_productCount_edit" class="col-md-3 text-right">汽车库存:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="product_productCount_edit" name="product.productCount" class="form-control" placeholder="请输入汽车库存">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="product_productDesc_edit" class="col-md-3 text-right">汽车描述:</label>
		  	 <div class="col-md-9">
...
<script>
//实例化编辑器
var product_productDesc_edit = UE.getEditor('product_productDesc_edit'); //汽车描述编辑器
