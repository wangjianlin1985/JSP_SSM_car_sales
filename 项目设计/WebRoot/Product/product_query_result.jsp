...
<div id="product_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="productQueryForm" method="post">
			汽车类别：<input class="textbox" type="text" id="productClassObj_classId_query" name="productClassObj.classId" style="width: auto"/>
			汽车名称：<input type="text" class="textbox" id="productName" name="productName" style="width:110px" />
...
var product_productDesc_editor = UE.getEditor('product_productDesc_edit'); //汽车描述编辑器
</script>
