		...
		<div class="col-md-12 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#productClassListPanel" aria-controls="productClassListPanel" role="tab" data-toggle="tab">汽车类别列表</a></li>
			    	<li role="presentation" ><a href="<%=basePath %>ProductClass/productClass_frontAdd.jsp" style="display:none;">添加汽车类别</a></li>
				</ul>
			  	<!-- Tab panes -->
				    				...
				    				<table class="table table-condensed table-hover">
				    					...
				    					<% 
				    	            		...
				    	            		for(int i=0;i<productClassList.size();i++) {
					    	            		...
					    	            		ProductClass productClass = productClassList.get(i); //获取到汽车类别对象
 										%>
 										<tr>
 											<td><%=currentIndex %></td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;汽车类别信息编辑</h4>
      </div>
