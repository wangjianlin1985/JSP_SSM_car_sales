...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">汽车4s店销售</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <!-- <li><a href="<%=basePath %>Member/frontlist">会员</a></li>
                 ...
                 <li><a href="<%=basePath %>ProductClass/frontlist">汽车类别</a></li>
                ...
                <li><a href="<%=basePath %>Product/frontlist">汽车查询</a></li>
                <li><a href="<%=basePath %>BuyInfo/frontlist">汽车进货</a></li> 
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="<%=basePath %>BuyInfo/buyInfo_frontEmpAdd.jsp"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;汽车进货登记</a></li>
                        <li><a href="<%=basePath %>BuyInfo/empFrontlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我的进货记录</a></li>
                        <li><a href="<%=basePath %>SellCart/sellCart_empFrontAdd.jsp"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;汽车销售登记</a></li>
