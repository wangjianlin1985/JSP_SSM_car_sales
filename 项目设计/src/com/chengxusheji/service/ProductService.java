...
public class ProductService {
    ...
    /*按照查询条件分页查询汽车记录*/
    public ArrayList<Product> queryProduct(ProductClass productClassObj,String productName,String addTime,int currentPage) throws Exception { 
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<Product> queryProduct(ProductClass productClassObj,String productName,String addTime) throws Exception  { 
     	String where = "where 1=1";
    	if(null != productClassObj && productClassObj.getClassId()!= null && productClassObj.getClassId()!= 0)  where += " and t_product.productClassObj=" + productClassObj.getClassId();
    	if(!productName.equals("")) where = where + " and t_product.productName like '%" + productName + "%'";
    	if(!addTime.equals("")) where = where + " and t_product.addTime like '%" + addTime + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(ProductClass productClassObj,String productName,String addTime) throws Exception {
     	String where = "where 1=1";
    	if(null != productClassObj && productClassObj.getClassId()!= null && productClassObj.getClassId()!= 0)  where += " and t_product.productClassObj=" + productClassObj.getClassId();
    	if(!productName.equals("")) where = where + " and t_product.productName like '%" + productName + "%'";
    	if(!addTime.equals("")) where = where + " and t_product.addTime like '%" + addTime + "%'";
